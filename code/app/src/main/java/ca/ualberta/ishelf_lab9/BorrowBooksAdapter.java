 ...
 * @author : Faisal
 */
class BorrowBooksAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
     ...
     */
    public BorrowBooksAdapter(Context bookContext, ArrayList<Book> filterList, ArrayList<Book> originalList) {
