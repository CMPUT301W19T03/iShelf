 ...
 * @author: Faisal
 */
public class BorrowBooksFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private BorrowBooksAdapter bookAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bookAdapter = new BorrowBooksAdapter(view.getContext(), bookList, bookList);
