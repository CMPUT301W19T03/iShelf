...
public class Database extends Application {
    // I think Firebase needs to be refreshed, but we need it for now, so I cannot change it for now
    // The app runs fine before, so this is the only thing causing an error
